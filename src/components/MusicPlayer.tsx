...
export const MusicPlayer = ({ currentTrack, onNextTrack, onPreviousTrack, onPlayStateChange, onTrackSelect, tracks, onAudioElementChange }: MusicPlayerProps) => {
  ...
  return (
    <div className={`fixed ${isMaximized ? 'inset-0' : 'bottom-6 left-1/2 -translate-x-1/2'} glass-morphism rounded-xl ${isMaximized ? 'z-50' : 'z-40'} ${!isMaximized && 'w-[calc(100%-4rem)] md:w-[calc(100%-4rem)] max-w-5xl'}`}>
        ...
        {isMaximized ? (
          <div className="flex flex-col items-center gap-8 w-full max-w-2xl">
            ...
            <div className="flex items-center gap-6">
              <button 
                className="h-14 w-14 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center text-white transition-all duration-200 hover:scale-110"
                onClick={onPreviousTrack}
              >
                <BackwardIcon className="h-8 w-8" />
              </button>
              <button 
                className="h-16 w-16 rounded-full bg-primary hover:bg-primary/90 flex items-center justify-center text-white transition-all duration-200 hover:scale-110"
                onClick={togglePlay}
              >
          ...
          <>
            ...
            <div className="absolute right-20 md:left-1/2 md:-translate-x-1/2 flex items-center gap-1 md:gap-2 justify-end md:justify-center">
              <button 
                className="h-10 w-10 md:h-12 md:w-12 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center text-white transition-all duration-200 hover:scale-110"
                onClick={onPreviousTrack}
              >
                <BackwardIcon className="h-5 w-5 md:h-6 md:w-6" />
              </button>
              <button 
                className="h-12 w-12 md:h-14 md:w-14 rounded-full bg-primary hover:bg-primary/90 flex items-center justify-center text-white transition-all duration-200 hover:scale-110"
                onClick={togglePlay}
              >
