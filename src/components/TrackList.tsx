...
export const TrackList = ({ tracks, onTrackSelect, currentTrack, isPlaying, audioElement }: TrackListProps) => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 pb-6">
      <div 
        className="bg-white/5 backdrop-blur-xl rounded-lg overflow-hidden shadow-lg mx-8 md:mx-0 glass-morphism"
        ref={containerRef}
      >
              ...
              {tracks.map((track) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative aspect-square w-12 h-12 md:w-16 md:h-16 rounded-lg overflow-hidden flex-shrink-0 group-hover:scale-105 transition-transform duration-200">
                      <img 
                        src={track.albumArt} 
                    ...
                    <div className="flex-shrink-0">
                      <div className={`p-1.5 md:p-2 rounded-full h-8 w-8 md:h-10 md:w-10 flex items-center justify-center transition-all duration-200 ${
                        ...
                        {isCurrentTrack ? (
                          ...
                          <MusicalNoteIcon className="h-4 w-4 text-white/40 group-hover:text-white/60" />
                        )}
                      </div>
                    </div>
                  </div>
      ...
      <div className="mt-16 mb-24 text-center">
        <div className="flex flex-col md:flex-row items-center justify-center gap-4">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            ...
            >
              <FontAwesomeIcon icon={faSoundcloud} className="w-5 h-5 text-white/60 group-hover:text-white transition-colors" />
            ...
            <a 
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 hover:bg-white/10 transition-all duration-200 group"
            >
              <EnvelopeIcon className="w-5 h-5 text-white/60 group-hover:text-white transition-colors" />
